...
function more(id) {
    ...
    //            '</li>' +
    //            '<li class="nav-item mx-1 mb-0">' +
    //            '<a class="nav-link  navs-color navachPaddig" data-toggle="tab" href="#menu3" onclick="color()">Drug Interactions</a>' +
    //            '</li>' +
    //            '<li class="nav-item mx-1 mb-0">' +
    //            '<a class="nav-link  navs-color navachPaddig" data-toggle="tab" href="#menu4" onclick="color()">Symptoms</a>' +
    //            '</li>' +
    //            '<li class="nav-item mx-1 mb-0">' +
    //            '<a class="nav-link  navs-color navachPaddig" data-toggle="tab" href="#menu5" onclick="color()">Indication and Usage</a>' +
    //            '</li> ').show('slow');
    ...
    //  '</li>'+
    //  '<li class="nav-item mx-1 mb-0">'+
    //    '<a class="nav-link  navs-color navachPaddig" data-toggle="tab" href="#menu8" onclick="color()">Drug Interactions</a>'+
    //  '</li>'+
    //  '<li class="nav-item mx-1 mb-0">'+
    //    '<a class="nav-link  navs-color navachPaddig" data-toggle="tab" href="#menu9" onclick="color()">Symptoms</a>'+
    //  '</li>'+
    //  '<li class="nav-item mx-1 mb-0">'+
