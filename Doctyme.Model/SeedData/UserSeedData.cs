...
namespace Doctyme.Model.SeedData
{
    public class UserSeedData
    {
        private readonly DoctymeDbContext _context;

        public UserSeedData(DoctymeDbContext context)
        {
            _context = context;
        }
        ...
        public void SeedAdminUser()
        {
            try
            {
                ...
                if (!_context.UserTypes.Any())
                {
                    ...
                    {
                        _context.UserTypes.AddRange(userTypeList);
