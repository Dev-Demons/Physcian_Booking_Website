...
var pagefunction = function () {
    ...
    //var $this = $("#googleMap");
    var $zoomLevel = ($("#googleMapTop").data("gmap-zoom") || 12);
    var $dataLat = ($("#googleMapTop").data("gmap-lat") || lat);
    var $dataLng = ($("#googleMapTop").data("gmap-lng") || lng);
    var $xmlSrc = ($("#googleMapTop").data("gmap-src") || "xml/gmap/pins.xml");
    ...
    function initializeMap() {
        ...
        var map = new window.google.maps.Map(document.getElementById("googleMapTop"), mapOptions);
...
function initialize() {
    var map = new google.maps.Map(
        document.getElementById("googleMapTop"), {
